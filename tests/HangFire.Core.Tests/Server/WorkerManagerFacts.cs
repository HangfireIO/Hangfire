...
namespace HangFire.Core.Tests.Server
{
    public class WorkerManagerFacts
    {
        ...
        private readonly Mock<WorkerManager2> _manager;
        ...
        public WorkerManagerFacts()
        {
            ...
            _manager = new Mock<WorkerManager2>(
        ...
        public void Ctor_ThrowsAnException_WhenServerIdIsNull()
        {
            var exception = Assert.Throws<ArgumentNullException>(
                () => new WorkerManager2(null, WorkerCount, Queues, _storage.Object, _process.Object));
        ...
        public void Ctor_ThrowsAnException_WhenWorkerCountLessOrEqualToZero()
        {
            var exception = Assert.Throws<ArgumentOutOfRangeException>(
                () => new WorkerManager2(ServerId, 0, Queues, _storage.Object, _process.Object));
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(
                () => new WorkerManager2(ServerId, WorkerCount, null, _storage.Object, _process.Object));
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(
                () => new WorkerManager2(ServerId, WorkerCount, Queues, null, _process.Object));
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(
                () => new WorkerManager2(ServerId, WorkerCount, Queues, _storage.Object, null));
        ...
        {
            var manager = new WorkerManager2(ServerId, WorkerCount, Queues, _storage.Object, _process.Object);
