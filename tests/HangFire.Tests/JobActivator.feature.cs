...
namespace HangFire.Tests
{
    ...
    public partial class JobActivatorFeature : Xunit.IUseFixture<JobActivatorFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public virtual void SetFixture(JobActivatorFeature.FixtureData fixtureData)
        {
        }
        ...
        [Xunit.FactAttribute()]
        [Xunit.TraitAttribute("FeatureTitle", "JobActivator")]
        [Xunit.TraitAttribute("Description", "Activator returns the job instance when its type has default constructor")]
...
#line hidden
        ...
        [Xunit.FactAttribute()]
        [Xunit.TraitAttribute("FeatureTitle", "JobActivator")]
        [Xunit.TraitAttribute("Description", "Activator throws an exception when the specified job type has no default construc" +
            "tor")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                JobActivatorFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                JobActivatorFeature.FeatureTearDown();
            }
        }
    }
}
