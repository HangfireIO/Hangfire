...
namespace HangFire.Tests
{
    ...
    public class ClientApiTests
    {
        ...
        public void Create_StaticExpression_CorrectlyDeterminesTypeAndMethod()
        {
            ...
            _jobClientMock.Verify(client => client.CreateJob(
                It.IsAny<string>(),
                It.Is<JobInvocationData>(x => x.Type == typeof(TestService) && x.Method.Name == "StaticMethod" && x.Parameters.Count == 0),
                It.IsAny<JobState>()));
        }
        ...
        public void Create_InstanceExpression_CorrectlyDeterminesTypeAndMethod()
        {
            ...
            _jobClientMock.Verify(client => client.CreateJob(
                It.IsAny<string>(),
                It.Is<JobInvocationData>(x => x.Type == typeof(TestService) && x.Method.Name == "InstanceMethod" && x.Parameters.Count == 0),
                It.IsAny<JobState>()));
        }
        ...
        public void Create_InstanceExpression_PassesParameterValuesAndTheirTypes_ToClient()
        {
            ...
            _jobClientMock.Verify(client => client.CreateJob(
                It.IsAny<string>(),
                It.Is<JobInvocationData>(x => x.Parameters[0].Item1 == typeof(string) && (string)x.Parameters[0].Item2 == "Hello"),
                It.IsAny<JobState>()));
        }
        ...
        public void Create_StaticExpression_PassesParameterValuesAndTheirTypes_ToClient()
        {
            ...
            _jobClientMock.Verify(client => client.CreateJob(
                It.IsAny<string>(),
                It.Is<JobInvocationData>(x => x.Parameters[0].Item1 == typeof(int) && (int)x.Parameters[0].Item2 == 34),
                It.IsAny<JobState>()));
        }
