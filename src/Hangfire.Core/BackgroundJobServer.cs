...
namespace Hangfire
{
    public class BackgroundJobServer : IDisposable
    {
        ...
        private IEnumerable<IServerProcess> GetProcesses()
        {
            ...
            {
                processes.Add(new Worker(new WorkerContext(_options.Queues, i + 1), _options.PerformanceProcess, _options.StateMachine));
            }
            ...
            processes.Add(new SchedulePoller(_options.SchedulePollingInterval, _options.StateMachine));
