...
namespace Hangfire
{
    public class BackgroundJobServer : IServerSupervisor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BackgroundJobServer"/> class
        /// with the specified options and the given storage and <see cref="JobFilterProviders.Providers"/> jobFilterProviders.
        /// </summary>
        /// <param name="options">Server options</param>
        /// <param name="storage">The storage</param>
        public BackgroundJobServer(BackgroundJobServerOptions options, JobStorage storage)
            : this(options, storage, JobFilterProviders.Providers)
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="BackgroundJobServer"/> class
        /// with the specified options, the given storage and the given jobFilterProviderCollection
        /// </summary>
        /// <param name="options">Server options</param>
        /// <param name="storage">The storage</param>
        /// <param name="jobFilterProviderCollection">filter providers</param>
        public BackgroundJobServer(BackgroundJobServerOptions options, JobStorage storage, JobFilterProviderCollection jobFilterProviderCollection)
        {
        ...
        {
            var performanceProcess = new DefaultJobPerformanceProcess(JobActivator.Current, _jobFilterProviderCollection);
            var stateMachineFactory = new StateMachineFactory(_storage, _jobFilterProviderCollection);
