...
namespace Hangfire
{
    ...
    public static class AppBuilderExtensions
    {
        ...
        {
            return builder.UseHangfireServer(JobStorage.Current, SystemClock.Current, new BackgroundJobServerOptions(), additionalProcesses);
        }
        ...
        {
            return builder.UseHangfireServer(options, JobStorage.Current, SystemClock.Current);
        }
        ...
        public static IAppBuilder UseHangfireServer(
            ...
            [NotNull] params IBackgroundProcess[] additionalProcesses)
        {
            return builder.UseHangfireServer(JobStorage.Current, SystemClock.Current, options, additionalProcesses);
        }
        ...
        {
            return builder.UseHangfireServer(storage, clock, options);
        }
            ...
            [NotNull] params IBackgroundProcess[] additionalProcesses)
        {
            ...
            var server = new BackgroundJobServer(options, storage, clock, additionalProcesses);
            Servers.Add(server);
        ...
        {
            return builder.UseHangfireDashboard(pathMatch, options, JobStorage.Current, SystemClock.Current);
        }
        ...
        public static IAppBuilder UseHangfireDashboard(
            ...
            [NotNull] IClock clock)
        {
            return builder.UseHangfireDashboard(pathMatch, options, storage, clock, null);
        }
            ...
            [CanBeNull] IOwinDashboardAntiforgery antiforgery)
        {
            ...
            builder.Map(pathMatch, subApp => subApp
                .UseOwin()
                .UseHangfireDashboard(options, storage, clock, DashboardRoutes.Routes, antiforgery));
