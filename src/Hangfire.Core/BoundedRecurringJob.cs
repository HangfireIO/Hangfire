...
namespace Hangfire
{
    public static class BoundedRecurringJob
    {
            ...
            DateTime? endDate = null)
        {
            ...
            Instance.Value.AddOrUpdateBounded(id, job, cronExpression, timeZone ?? TimeZoneInfo.Utc, queue, startDate, endDate);
        }
        ...
        {
            var job = Job.FromExpression(methodCall);
            Instance.Value.AddOrUpdateBounded(recurringJobId, job, cronExpression, timeZone ?? TimeZoneInfo.Utc, queue, startDate, endDate);
        }
