...
namespace Hangfire.Dashboard
{
    public abstract class DashboardContext
    {
        ...
        protected DashboardContext([NotNull] JobStorage storage, [NotNull] IClock clock, [NotNull] DashboardOptions options)
        {
        ...
        {
            return new BackgroundJobClient(Storage, Clock);
        }

        public virtual IRecurringJobManager GetRecurringJobManager()
        {
            return new RecurringJobManager(Storage, Clock);
        }
    }
}
