...
namespace Hangfire.Client
{
    ...
    public class CreateContext
    {
        public CreateContext([NotNull] CreateContext context)
            : this(context.Storage, context.Clock, context.Connection, context.Job, context.InitialState, context.Profiler)
        {
            Items = context.Items;
        ...
        public CreateContext(
            ...
            : this(storage, clock, connection, job, initialState, EmptyProfiler.Instance)
        {
        }
        ...
        [NotNull] public virtual IDictionary<string, object> Parameters { get; }

        [NotNull] public Job Job { get; }
